import { parsePhone } from '../src/parse-phone-jon.js'
import chai from 'chai'

chai.should()

describe(`helpers.entry.parsePhoneJon`, function() {
  ...
  it(`null results in null`, () => {

    (parsePhone(null) === null).should.be.true
  })

  it(`undefined results in null`, () => {

    (parsePhone(undefined) === null).should.be.true
  })

  it(`boolean false results in null`, () => {

    (parsePhone(false) === null).should.be.true
  })
  ...
  it(`9999 ??? 999 99 9999 without extension (default case)`, () => {
    ...
    result.number.should.exist
    result.number.should.be.eq(`1234567890123456`)

    // why is this one formatted?
    result.full.should.exist
    result.full.should.be.eq(`1234567890123456`)
